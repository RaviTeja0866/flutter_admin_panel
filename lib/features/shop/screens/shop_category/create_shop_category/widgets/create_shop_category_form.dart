...
import 'package:roguestore_admin_panel/features/shop/controllers/shop_category/create_shop_category_contorller.dart';
...
class CreateShopCategoryForm extends StatelessWidget {
  const CreateShopCategoryForm({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(CreateShopCategoryController());
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Create New Shop Category', style: Theme.of(context).textTheme.headlineMedium),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () => controller.createShopCategory(),
                child: Text('Create'),
              ),
            ),
            SizedBox(height: RSSizes.spaceBtwInputFields * 2),
