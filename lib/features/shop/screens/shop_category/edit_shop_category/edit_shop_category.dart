...
class EditShopCategory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final shopCategoryId = Get.parameters['id']!;

    return RSSiteTemplate(
      desktop: EditShopCategoryDesktopScreen(shopCategoryId: shopCategoryId),
      tablet: EditShopCategoryTabletScreen(shopCategoryId: shopCategoryId),
      mobile: EditShopCategoryMobileScreen(shopCategoryId: shopCategoryId),
    );
  }
}
