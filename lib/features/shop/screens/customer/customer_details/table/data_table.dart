...
import 'package:roguestore_admin_panel/features/shop/screens/customer/customer_details/table/table_source.dart';
      ...
      () {
        ...
        return  RSPaginatedDataTable(
            ...
            columns: [
              ...
              DataColumn2(label: Text('Status'), fixedWidth: RSDeviceUtils.isMobileScreen(context) ? 100 : null),
