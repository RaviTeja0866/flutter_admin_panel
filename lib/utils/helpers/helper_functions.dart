...
class RSHelperFunctions {
  ...
  static Color getExchangeStatusColor(ExchangeStatus status) {
    switch (status) {
      ...
      case ExchangeStatus.completed:
        return Colors.green;
      case ExchangeStatus.  pickedUp:
      case ExchangeStatus.shipped:
        return Colors.blue;
  ...
  static Color getReturnStatusColor(ReturnStatus status) {
    switch (status) {
